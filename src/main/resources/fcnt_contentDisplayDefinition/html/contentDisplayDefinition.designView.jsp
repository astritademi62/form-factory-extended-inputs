    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <span class="cursorPointer preventSelect"
                ...
                <i ng-click="cdc.updateTitlePosition('indent')"
                   ng-class="{'disabled':!input.displayTitle}"
                   class="fa fa-indent"></i>
            </span>
            &nbsp;
            <span class="cursorPointer preventSelect"
                  uib-tooltip="{{cdc.i18nMessageGetter('angular.contentDisplayDirective.tooltip.indent')}}">
                <i ng-click="cdc.updateTitlePosition('outdent')"
                   ng-class="{'disabled':!input.displayTitle}"
                   class="fa fa-outdent"></i>
            </span>
            <input type="text" ng-disabled="!input.displayTitle" class="form-control" ng-change="cdc.syncTitle()" ng-model="input.title"/>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="form-group">
